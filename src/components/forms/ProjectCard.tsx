...
export function ProjectCard({ project, index, total, onChange, onDelete, onMove, limits }: {
  ...
  return (
    <Card className="p-3 space-y-3">
      ...
      <Field label="Bullets"><BulletsEditor maxBullets={limits.bullets} maxChar={limits.maxBulletsCharLength} bullets={project.bullets} onChange={(b) => onChange({ ...project, bullets: b })} /></Field>
    </Card>
  );
}
